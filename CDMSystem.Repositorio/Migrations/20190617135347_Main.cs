...
namespace CDMSystem.Repositorio.Migrations
{
    public partial class Main : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdUsuario = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    EmailUsuario = table.Column<string>(type: "varchar(120)", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OminiSkill_Item_IdItemOminiSkill",
                        column: x => x.IdItemOminiSkill,
                        principalTable: "Item",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OminiSkill_Item_ItemIdItem",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdPersonagem = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    IdUsuarioPersonagem = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Personagem_Usuario_IdUsuarioPersonagem",
                        column: x => x.IdUsuarioPersonagem,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OminiSkill_IdItemOminiSkill",
                table: "OminiSkill",
                column: "IdItemOminiSkill");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Personagem_IdUsuarioPersonagem",
                table: "Personagem",
                column: "IdUsuarioPersonagem");
